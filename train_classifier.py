...
import torch.optim as optim_v
import torch.optim.lr_scheduler as lr_scheduler_v
import datasets
import models
import utils
...
def classifier_save_path(config):
    ...
    if args.tag is not None:
        svname += '_' + args.tag
    save_path = os.path.join('./save', svname, 'ResNet152')
...
if __name__ == '__main__':
    ...
    # Josh
    parser.add_argument('--config', default="./configs/train_classifier_fc100.yaml")
    # parser.add_argument('--dataset', type=str, default='CIFAR_FS', choices=['mini', 'CIFAR_FS'])
    parser.add_argument('--name', default=None)
    parser.add_argument('--tag', default=None)
    parser.add_argument('--gpu', default='0')
    parser.add_argument('--ViT', action='store_true')
    parser.add_argument('--freeze', action='store_true', help='apply freeze or not')
    parser.add_argument('--transfer', action='store_true', help='apply transfer or not')
    # parser.add_argument('--mydataset', action='store_true', help='using my dataset or not')
